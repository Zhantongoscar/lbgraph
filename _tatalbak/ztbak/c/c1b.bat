...
g++ -v c1b_create_vertexpoint_table.cpp -o c1b_vertexpoint.exe -I%MYSQL_INC% -L%MYSQL_LIB% -g -Wall "C:/clib/mysql/lib/libmysql.lib" -lwsock32 -lws2_32 > build_log.txt 2>&1
