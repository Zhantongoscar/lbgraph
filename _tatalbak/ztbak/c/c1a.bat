...
g++ -v c1a_create_devicepoint_table.cpp -o c1a_devicepoint.exe -I%MYSQL_INC% -L%MYSQL_LIB% -g -Wall "C:/clib/mysql/lib/libmysql.lib" -lwsock32 -lws2_32 > build_log.txt 2>&1
