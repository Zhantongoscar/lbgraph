...
set "COMPILE_CMD=g++ -o c2b_import_excel.exe c2b_importExcelLeyboldPart.cpp -I"%MYSQL_INC%" -I. -I"%INCLUDE_DIR%" -L"%MYSQL_LIB%" -g -Wall "%MYSQL_LIB%\libmysql.lib" -lwsock32 -lws2_32"
